...
unsafe public sealed partial class GUIRenderer
{
    ...
    public void Update(IntPtr imGuiContext, SizeI newSize)
    {
        ...
        io.DeltaTime = 0.16f;
        io.DisplaySize = new(newSize.Width, newSize.Height);
...
unsafe public sealed partial class GUIRenderer
{
    ...
    private void CreateViewConstantBuffer(ImDrawDataPtr data)
    {
        ...
        ViewConstantBuffer viewConstantBuffer = new(mvp, Vector3.Zero);
...
unsafe public sealed partial class GUIRenderer
{
    ...
    {
        string directoryPath = AppContext.BaseDirectory + @"Shaders\";

        vertexShaderByteCode = CompileBytecode(DxcShaderStage.Vertex, directoryPath + shaderFilePath, "VSMain");

        pixelShaderByteCode = CompileBytecode(DxcShaderStage.Pixel, directoryPath + shaderFilePath, "PSMain");
    }
