...
public sealed partial class GraphicsDevice : IDisposable
{
    ...
    public void Initialize()
    {
        ...
        DescriptorHeapDescription CBVSRVUAVDescriptorHeapDescription = new()
        {
        ...
        CBVSRVUAVHeap.Initialize(this, CBVSRVUAVDescriptorHeapDescription);

        DescriptorHeapDescription DepthStencilViewDescriptorHeapDescription = new()
        {
            DescriptorCount = 64,
        ...
        DepthStencilViewHeap.Initialize(this, DepthStencilViewDescriptorHeapDescription);

        DescriptorHeapDescription RenderTextureViewDescriptorHeapDescription = new()
        {
            DescriptorCount = 64,
        ...
        RenderTextureViewHeap.Initialize(this, RenderTextureViewDescriptorHeapDescription);
...
public sealed partial class GraphicsDevice : IDisposable
{
    ...
    public Queue<ResourceDelayDestroy> DelayDestroy { get; set; } = new();
